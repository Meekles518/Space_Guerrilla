...
public class Player_Bullet : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        PlayerBulletInfo playerBulletInfo = GameManager.instance.playerBulletInfo;

        
        speed = playerBulletInfo.speed; //Speed 저장
        spreadRange = playerBulletInfo.spreadRange; //spreadRange 저장
